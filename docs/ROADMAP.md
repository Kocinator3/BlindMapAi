...
- Offline European rivers and worldwide city/capital markers (circles/pentagons), with per-level visibility.
...
3. Add supported per-question map overrides, full viewport settings and expanded offline coastline/internal/worldwide-river/lake layers without answer leakage.
