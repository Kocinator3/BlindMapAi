...
- Schema v1 intentionally rejects Polygon holes/MultiPolygon and unknown fields. Map layers include country outlines, worldwide rivers and major cities/capitals without labels. Per-question overrides, lakes and full viewport controls remain unfinished.
