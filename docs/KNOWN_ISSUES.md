...
- Schema v1 intentionally rejects Polygon holes/MultiPolygon and unknown fields. Map layers include country outlines, European rivers and worldwide major cities/capitals without labels. Per-question overrides, worldwide rivers, lakes and full viewport controls remain unfinished.
